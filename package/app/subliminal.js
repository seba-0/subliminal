...
Ext.Direct.addProvider({
    "url": "webman/3rdparty/subliminal/subliminal.cgi/direct/router",
        ...
        config = Ext.apply({
            ...
            items: [{
                ...
                items: [{
                    ...
                    xtype: "checkbox",
                    fieldLabel: _V("ui", "single"),
                    name: "single"
                }, {
                    xtype: "checkbox",
                    fieldLabel: _V("ui", "hearing_impaired"),
                    name: "hearing_impaired"
                }, {
                    xtype: "numberfield",
                    fieldLabel: _V("ui", "min_score"),
                    name: "min_score",
                    allowBlank: false,
                    allowDecimals: false,
                    allowNegative: false,
                ...
                xtype: "fieldset",
                labelWidth: 130,
                title: _V("ui", "opensubtitles"),
                defaultType: "textfield",
                items: [{
                    fieldLabel: _V("ui", "username"),
                    name: "opensubtitles_user",
                },{
                    fieldLabel: _V("ui", "password"),
                    name: "opensubtitles_pass",
					inputType: 'password'
                }]
            }, {
                xtype: "fieldset",
                labelWidth: 130,
                title: _V("ui", "addic7ed"),
                defaultType: "textfield",
                items: [{
                    fieldLabel: _V("ui", "username"),
                    name: "addic7ed_user",
                ...
                xtype: "fieldset",
                labelWidth: 130,
                title: _V("ui", "legendastv"),
                defaultType: "textfield",
                items: [{
                    fieldLabel: _V("ui", "username"),
                    name: "legendastv_user",
                },{
                    fieldLabel: _V("ui", "password"),
                    name: "legendastv_pass",
					inputType: 'password'
                }]
            }, {
                xtype: "fieldset",
                labelWidth: 130,
                title: _V("ui", "subscenter"),
                defaultType: "textfield",
                items: [{
                    fieldLabel: _V("ui", "username"),
                    name: "subscenter_user",
                },{
                    fieldLabel: _V("ui", "password"),
                    name: "subscenter_pass",
					inputType: 'password'
                }]
            }],
            api: {
    ...
    initComponent: function () {
        this.panel = new Ext.tree.TreePanel({
            ...
            root: {
                ...
                expanded: true,
                allowDrop: false,
                icon: "/webman/resources/images/icon_dsm_16.png",
                cls: "root_node"
            },
            listeners: {
                scope: this,
