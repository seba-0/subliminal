...
class CronTab(object):
    ...
    def run(self):
        ...
        logger.info(u'Scaning at %s:%s' % (self.subliminal.config['Task']['hour'], self.subliminal.config['Task']['minute']))
        while self.running:
...
if __name__ == '__main__':
    pidfile = '/var/packages/subliminal/target/var/scheduler.pid'
    logfile = '/var/packages/subliminal/target/var/scheduler.log'
